...
# 0
main_menu_text = [['Exit', 'Play', 'Settings', 'Credits', 'SPACE KID'], [(653, 460, 90, 55), (648, 250, 100, 55),
                                                                         (606, 320, 185, 55), (619, 390, 160, 55),
                                                                         (530, 20, 380, 100)], [55, 55, 55, 55, 100],
                  [0, 4]]
# 1
...
settings_text = [['Back', 'Graphics', 'Controls', 'Audio', 'Settings'],
                 [(20, 30, 100, 60), (620, 290, 180, 55), (623, 360, 175, 55), (647, 430, 120, 55),
                  (573, 170, 260, 80)], [50, 50, 50, 50, 80], [0, 4]]
# 1
...
settings_controls_text = [['Back', 'W', 'S', 'Control'], [(20, 30, 100, 60), (620, 290, 190, 55),
                          ...
                          [0, 3]]
# 3
window_size = [['Back', 'Full Screen', 'Window', 'Window Size'],
               [(20, 30, 100, 60), (540, 170, 380, 80), (615, 290, 220, 55), (644, 380, 165, 55)],
               [50, 50, 50, 80], [0, 3]]
# 3
...
def get_surface(index):
    surface_prop = {0: main_menu_text, 1: [0, play, settings_text, credits_text],
                    2: [play, settings_graphics_text, settings_controls_text], 3: [window_size, fps_text]}
