...
class GameMenu:
    ...
    def main_menu(self):
        ...
        while not play:
            ...
            play = self.game_window.display(rect_class, functions_list, mouse_pos, background_image)
    ...
    def menu_credits(self, image):
        ...
        while not go_back:
            ...
            go_back = self.game_window.display(rect_class, functions_list, mouse, image)
    ...
    def menu_settings(self, image):
        ...
        while not go_back:
            ...
            go_back = self.game_window.display(rect_class, functions_list, mouse_pos, image)
            pygame.display.update()
            CLOCK.tick(self.game_window.fps)
    ...
    def menu_settings_graphics(self, image):
        rect_class = rectangleClass.settings_graphics
        ...
        while not go_back:
            ...
            self.game_window.gameScreen.blit(image, (0, 0))
            go_back = self.game_window.display(rect_class, function_list, mouse_pos, image)

            pygame.display.update()
            CLOCK.tick(self.game_window.fps)

    def menu_settings_graphics_screen_size(self, image):
        rect_class = rectangleClass.settings_graphics_window_size
    ...
    def menu_settings_graphics_fps(self, image):
        rect_class = rectangleClass.settings_graphics_fps
